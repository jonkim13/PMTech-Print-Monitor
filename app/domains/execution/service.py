...
class ExecutionService:
    ...
    def get_upload_session(self, upload_session_id: str) -> Optional[dict]:
        return self.upload_session_db.get_session(upload_session_id)
...
UploadWorkflowService = ExecutionService
